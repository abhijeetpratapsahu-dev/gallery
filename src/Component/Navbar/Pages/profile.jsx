...
const Home = () => {
  return (
    <div className='bg-white min-h-full text-black relative'>
      ...
      <div className='h-auto w-[270vw] border-2 border-black p-6 leading-7 rounded-lg absolute left-[2vw] bottom-[35vh]'> 
      ...
      <div className='absolute left-4 bottom-[55vh] border-2 border-black p-3'>
