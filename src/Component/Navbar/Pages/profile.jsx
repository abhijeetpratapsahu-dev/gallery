...
const Home = () => {
  return (
    <div className='bg-white min-h-full min-w-full text-black relative'>
      <img className='h-40 w-40 rounded-full object-cover absolute left-[109vw] top-[11vh]' src={profile}></img>

      <House className='absolute left-2 bottom-150 cursor-pointer hover:text-blue-300' onClick={function(){
          window.location.href = "/"
      }}/>

      <div className='h-auto w-[83vw] border-2 border-black p-4 leading-7 font-bold font-sans rounded-lg absolute left-[101vw] bottom-[35vh]'> 
